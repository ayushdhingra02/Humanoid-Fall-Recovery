...
class ActorCritic(nn.Module):
    ...
    def __init__(self, num_obs,
        ...
        print(f"{num_obs_history} : num_obs_history")  # Should print torch.Size([57])
        ...
        adaptation_module_layers.append(
            nn.Linear(self.num_obs_history, AC_Args.adaptation_module_branch_hidden_dims[0]))
    ...
    def update_distribution(self, observation_history):
        # print(observation_history.shape)  # Should print torch.Size([57])
